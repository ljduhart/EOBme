...
object EobStrings {
    ...
    private val english = mapOf(
        ...
        "appealGeneratorFlaggedClaims" to "Flagged claims",
        "appealGeneratorFlaggedClaimChip" to "%1\$s • %2\$s",
        "appealGeneratorSelectClaimHint" to "Select a flagged claim above to open a filled appeal draft.",
