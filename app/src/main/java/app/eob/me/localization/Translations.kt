...
object Translations {
    ...
    private val english = mapOf(
        ...
        "profileRequiredHelp" to "First name, last name, email, password, city, and state are required. Insurance name and insurance group number are optional.",
        "passwordRule" to "Password must be at least 8 characters and include at least 1 number.",
        "returningUserSignIn" to "Sign in for returning users",
        "verifyEmail" to "Verify your email",
        "verificationCodeHelp" to "Enter the code sent to your email to finish account setup.",
        "verificationCode" to "Verification code",
        "verifyCode" to "Verify code",
        "resendCode" to "Resend code",
        "backToCreateAccount" to "Back to create account",
        "home" to "Home",
        ...
        "insuranceName" to "Insurance name",
        "insuranceGroupNumber" to "Insurance group number",
