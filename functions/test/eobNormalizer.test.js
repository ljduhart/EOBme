...
test("maps Veryfi AnyDocs health_insurance_eob nested claims payload into normalized EOB fields", () => {
  const normalized = veryfiToEobDocument(healthTexasInsuranceEobPayload(), {
